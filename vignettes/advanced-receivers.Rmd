...
For truly high-volume scenarios, consider async logging (planned for v0.2.0):

```{r async-future, eval=FALSE}
# Planned for v0.2.0 using mirai package
to_async_parquet() %>%
  on_local(path = "events.parquet", flush_threshold = 1000)
...
See `docs/async-logging-research.md` for detailed async implementation plan.
